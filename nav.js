(function () {
    ...
    s.textContent = [
        ...
        '.nav-status-icon{display:none;flex-shrink:0;align-items:center;justify-content:center;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:10px;width:36px;height:36px;cursor:pointer;color:white}',
        '@media (max-width:767px){.nav-status-icon{display:flex}}'
    ].join('');
